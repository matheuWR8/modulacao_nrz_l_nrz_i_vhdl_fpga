...
- [Tutorial de gravação na placa](./docs/Tutorial_NRZI_Placa.pdf) - como sintetizar, gerar bitstream e gravar na FPGA
...
4. **Grave na placa** seguindo o [tutorial de gravação](./docs/Tutorial_NRZI_Placa.pdf)
